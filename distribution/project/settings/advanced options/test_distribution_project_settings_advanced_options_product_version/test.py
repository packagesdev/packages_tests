...
# Check that the product version is correctly set during the build process

test_displayed_name="distribution > project > settings > advanced option > product version"

# Given

dirname = os.path.dirname(__file__)
projectpath = os.path.join(dirname, 'test_distribution_project_settings_advanced_options_product_version.pkgproj')
...
expected_distribution_product_id='1.0'
...
product_id=options_node.attrib['version']

...
# Check that the hostArchitectures value is automatically set to x86_64 when the payload contains a Universal 64-bit binary and the resources contain no binaries

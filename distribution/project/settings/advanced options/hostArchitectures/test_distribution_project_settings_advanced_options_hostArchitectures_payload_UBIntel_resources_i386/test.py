...
# Check that the hostArchitectures value is automatically set to i386 when the payload contains a Universal Intel binary and the resources contain a i386 binary

test_displayed_name="distribution > project > settings > advanced option > host architectures > payload: UBIntel / resources: i386"

# Given

dirname = os.path.dirname(__file__)
projectpath = os.path.join(dirname, 'test_distribution_project_settings_advanced_options_hostArchitectures_payload_UBIntel_resources_i386.pkgproj')

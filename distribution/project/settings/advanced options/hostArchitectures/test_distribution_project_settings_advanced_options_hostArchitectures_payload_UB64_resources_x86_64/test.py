...
# Check that the hostArchitectures value is automatically set to x86_64 when the payload contains a Universal 64-bit binary and the resources contain a x86_64 binary

test_displayed_name="distribution > project > settings > advanced option > host architectures > payload: UB64 / resources: x86_64"

# Given

dirname = os.path.dirname(__file__)
projectpath = os.path.join(dirname, 'test_distribution_project_settings_advanced_options_hostArchitectures_payload_UB64_resources_x86_64.pkgproj')

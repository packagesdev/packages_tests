...
# Check that the hostArchitectures value is automatically set to arm64,x86_64 when the payload contains no binaries and the resources contain a Universal 64-bit binary

test_displayed_name="distribution > project > settings > advanced option > host architectures > payload: none / resources: UB64"

# Given

dirname = os.path.dirname(__file__)
projectpath = os.path.join(dirname, 'test_distribution_project_settings_advanced_options_hostArchitectures_payload_none_resources_UB64.pkgproj')

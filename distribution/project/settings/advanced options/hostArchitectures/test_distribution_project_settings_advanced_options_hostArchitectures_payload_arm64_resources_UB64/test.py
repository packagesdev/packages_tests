...
# Check that the hostArchitectures value is automatically set to arm64 when the payload contains a arm64 binary and the resources contain a Universal 64-bit binary

test_displayed_name="distribution > project > settings > advanced option > host architectures > payload: arm64 / resources: UB64"

# Given

dirname = os.path.dirname(__file__)
projectpath = os.path.join(dirname, 'test_distribution_project_settings_advanced_options_hostArchitectures_payload_arm64_resources_UB64.pkgproj')

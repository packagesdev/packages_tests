...
test_displayed_name="distribution > packages > payload > settings > default destination - /"

# Given

dirname = os.path.dirname(__file__)
projectpath = os.path.join(dirname, 'test_distribution_packages_payload_settings_default-destination_root.pkgproj')

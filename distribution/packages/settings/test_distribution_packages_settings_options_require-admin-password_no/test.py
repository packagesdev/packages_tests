...
# Check that the auth option is set to none for the package during the build process

test_displayed_name="distribution > packages > settings > options > require admin password - no"

# Given

dirname = os.path.dirname(__file__)
projectpath = os.path.join(dirname, 'test_distribution_packages_settings_options_require-admin-password_no.pkgproj')

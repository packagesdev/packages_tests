...
# Check that the relocatable option is set to true for the package during the build process

test_displayed_name="distribution > packages > settings > options > relocatable - yes"

# Given

dirname = os.path.dirname(__file__)
projectpath = os.path.join(dirname, 'test_distribution_packages_settings_options_relocatable.pkgproj')

...
# Check that the version is set to the value defined in the settings during the build process

test_displayed_name="distribution > packages > settings > tag > version"

# Given

dirname = os.path.dirname(__file__)
projectpath = os.path.join(dirname, 'test_distribution_packages_settings_tag_version.pkgproj')
...
if (expected_version == version):
    ...
    print("    Expected: '{}' ; Found: \033[91m'{}'\033[0m".format(expected_version,version))

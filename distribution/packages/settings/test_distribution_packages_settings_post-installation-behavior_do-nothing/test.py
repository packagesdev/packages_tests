...
# Check that the post installation action is not set for the package during the build process

test_displayed_name="distribution > packages > settings > post-installation behavior > do nothing"

# Given

dirname = os.path.dirname(__file__)
projectpath = os.path.join(dirname, 'test_distribution_packages_settings_post-installation-behavior_do-nothing.pkgproj')
...
if not 'postinstall-action' in root.attrib:

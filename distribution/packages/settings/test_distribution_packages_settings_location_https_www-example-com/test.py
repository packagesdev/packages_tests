...
# Check that the package is created in the https folder and that the pkg-ref has the proper http URL for the reference path.

test_displayed_name="distribution > packages > settings > location > https - www.example.com"

# Given

dirname = os.path.dirname(__file__)
projectpath = os.path.join(dirname, 'test_distribution_packages_settings_location_https_www-example-com.pkgproj')
...
expected_reference_path="https://www.example.com/package.pkg"
...
if (os.path.exists(os.path.join(build_directory, 'https', 'package.pkg')) == False ):

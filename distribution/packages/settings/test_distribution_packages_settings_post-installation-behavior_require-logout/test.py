...
test_displayed_name="distribution > packages > settings > post-installation behavior > require logout"

# Given

dirname = os.path.dirname(__file__)
projectpath = os.path.join(dirname, 'test_distribution_packages_settings_post-installation-behavior_require-logout.pkgproj')
...
expected_postinstall_action='logout'

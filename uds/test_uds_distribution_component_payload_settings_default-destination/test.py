...
# Check that a component of the install location defined as the DEFAULT_DESTINATION_LAST_COMPONENT user defined setting is correctly converted during the build process

test_displayed_name="uds > distribution > component > payload > settings > default destination - dynamic value"

# Given

user_defined_default_destination_last_component='custom'
...
process = subprocess.Popen(['/usr/local/bin/packagesbuild', '--project', projectpath , 'DEFAULT_DESTINATION_LAST_COMPONENT={}'.format(user_defined_default_destination_last_component)],
...
expected_install_location="/Applications/custom"

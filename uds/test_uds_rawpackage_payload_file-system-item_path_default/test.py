...
# Check that the relative path of the file defined by the FILE_NAME user defined setting uses the default value set during the build process

test_displayed_name="uds > raw package > payload > file system path - default value"

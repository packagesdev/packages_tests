...
# Check that the warning components of the distribution requirement defined as the LOCALIZED_WARNING_TITLE and LOCALIZED_WARNING_MESSAGE user defined settings use the default values set during the build process

test_displayed_name="uds > distribution > requirement > localized warning - default value"
...
expected_localizable_string_line_1=u'\"REQUIREMENT_FAILED_MESSAGE_INSTALLATION_CHECK_1\" = \"default\";'
expected_localizable_string_line_2=u'\"REQUIREMENT_FAILED_DESCRIPTION_INSTALLATION_CHECK_1\" = \"default\";'

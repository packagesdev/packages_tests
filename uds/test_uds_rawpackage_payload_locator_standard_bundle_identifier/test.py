...
# Check that the app locator bundle identifier defined as the LOCATOR_BUNDLE_IDENTIFIER user defined settings is correctly converted during the build process

test_displayed_name="uds > raw package > payload > locator > standard bundle identifier - dynamic value"

# Given

user_defined_locator_bundle_identifier='inc.acme.application'
...
process = subprocess.Popen(['/usr/local/bin/packagesbuild', '--project', projectpath, 'LOCATOR_BUNDLE_IDENTIFIER={}'.format(user_defined_locator_bundle_identifier) ],
...
expected_locator_bundle_identifier='inc.acme.application'

...
# Check that the identifier of the package set by the PACKAGE_IDENTIFIER user defined setting is correctly converted during the build process

test_displayed_name="uds > raw package > identifier - dynamic"

# Given

user_defined_identifier='inc.acme.test'
...
process = subprocess.Popen(['/usr/local/bin/packagesbuild', '--project', projectpath , 'PACKAGE_IDENTIFIER={}'.format(user_defined_identifier)],
...
expected_identifier='inc.acme.test'

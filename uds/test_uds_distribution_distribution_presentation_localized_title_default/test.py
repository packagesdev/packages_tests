...
# Check that the title of the distribution defined as the PRESENTATION_TITLE uses the default value set during the build process

test_displayed_name="uds > distribution > presentation > localized title - default value"
...
expected_localizable_string_line=u'\"DISTRIBUTION_TITLE\" = \"default\";'

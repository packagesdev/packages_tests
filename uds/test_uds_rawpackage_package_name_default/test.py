...
# Check that the name of the package defined as the PACKAGE_NAME user defined setting uses the default value set during the build process

test_displayed_name="uds > raw package > package name - default value"
